// To parse this data:
//
//   import { Convert, SerchGifsResponse } from "./file";
//
//   const serchGifsResponse = Convert.toSerchGifsResponse(json);
//
...
export class Convert {
    public static toSerchGifsResponse(json: string): SerchGifsResponse {
        return cast(JSON.parse(json), r("SerchGifsResponse"));
    }

    public static serchGifsResponseToJson(value: SerchGifsResponse): string {
        return JSON.stringify(uncast(value, r("SerchGifsResponse")), null, 2);
    }
}
